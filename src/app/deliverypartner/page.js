...
const loginHandle=async ()=>{
    ...
    if(response.success){
        ...
        alert(" failed to login and try again with valid mobile and password");
    }
}
    ...
    <div>
      ...
      <div className="auth-container">
        ...
        <div className="input-wrapper">
            ...
            <div className="input-wrapper">
                <input type="text" className="input-field" value={password} onChange={(event)=>setPassword(event.target.value)} placeholder=" password" />
            </div>
